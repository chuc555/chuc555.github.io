$(document).ready(function() {
	...
	// THIS makes the plants increase in height
	$(document).click(function(e) {
		...
		//====== leaves for plant_01 ======
		if ((plantHeight > 29) && (plantHeight < 49) && (xValue > 0) && (xValue <205)) {
			$('#p1_leaf_01').show();
		} else if ((plantHeight > 49) && (plantHeight < 69) && (xValue > 0) && (xValue <205)) {
			$('#p1_leaf_03').show();
		} else if ((plantHeight > 69) && (plantHeight < 89) && (xValue > 0) && (xValue <205)) {
			$('#p1_leaf_02').show();
		} else if ((plantHeight > 89) && (plantHeight < 121) && (xValue > 0) && (xValue <205)) {
			$('#p1_leaf_04').show();
		};
